...
function login($username,$password)
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => "https://api.premierwallets.com/api/MerchantLogin",
...
function pushPayment($token,$amount,$CustomerWalletID,$MerchantID)
	{
	   ...
	   //	echo $CustomerWalletID .'     '.'Push';
		...
		$curl = curl_init();
		curl_setopt_array($curl, array(
			CURLOPT_URL => 'https://api.premierwallets.com/api/PushPayment',
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => '',
			CURLOPT_MAXREDIRS => 10,
			CURLOPT_TIMEOUT => 0,
...
function callBackApi($token,$transaction_id,$MerchantID)
        	{
              ...
              // echo $transaction_id;
        		...
        		$curl = curl_init();
        		curl_setopt_array($curl, array(
        			CURLOPT_URL => 'https://api.premierwallets.com/api/GetPaymentDetails',
        			CURLOPT_RETURNTRANSFER => true,
        			CURLOPT_ENCODING => '',
        			CURLOPT_MAXREDIRS => 10,
        			CURLOPT_TIMEOUT => 0,
